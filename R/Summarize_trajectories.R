...
#' @param video.description.folder folder in which video descriptions are found
...
#output summary data
if (write==TRUE){saveRDS(morph_mvt, file = file.path(to.data, merged.data.folder, par_morph_mvt()))}
